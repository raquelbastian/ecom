...
export async function getRecommendations(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend/${encodeURIComponent(productId)}?n=${n}`);
...
export async function getRecommendationsPCA(productId: string, n: number = 5, n_components: number = 50) {
  try {
    const response = await axios.get(`${API_URL}/recommend_pca/${encodeURIComponent(productId)}?n=${n}&n_components=${n_components}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsReviews(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend_reviews/${encodeURIComponent(productId)}?n=${n}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsContent(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend_content/${encodeURIComponent(productId)}?n=${n}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsSentiment(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend_sentiment/${encodeURIComponent(productId)}?n=${n}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsContentPCA(productId: string, n: number = 5, n_components: number = 50) {
  try {
    const response = await axios.get(`${API_URL}/recommend_content_pca/${encodeURIComponent(productId)}?n=${n}&n_components=${n_components}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsTopic(productId: string, n: number = 5, n_topics: number = 10) {
  try {
    const response = await axios.get(`${API_URL}/recommend_topic/${encodeURIComponent(productId)}?n=${n}&n_topics=${n_topics}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsReviewerOverlap(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend_reviewer_overlap/${encodeURIComponent(productId)}?n=${n}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getRecommendationsHybrid(productId: string, n: number = 5) {
  try {
    const response = await axios.get(`${API_URL}/recommend_hybrid/${encodeURIComponent(productId)}?n=${n}`);
    return response.data; // expected shape: { recommendations: [...] }
  } catch (error) {
...
export async function getTrendingProducts(n: number = 8) {
  try {
    const response = await axios.get(`${API_URL}/trending_products?n=${n}`);
...
export async function getTrendingProductsML(n: number = 8) {
  try {
    const response = await axios.get(`${API_URL}/trending_products_ml?n=${n}`);
    return response.data; // expected shape: { trending: [...] }
  } catch (error) {
